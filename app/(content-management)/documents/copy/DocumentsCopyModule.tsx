...
import { PagesHierarchicalList } from '@/components'
import CopyPagesModal from './modals/CopyPagesModal'

// Contexts
import { ConfigurationContext, LoadingContext } from '@/contexts'

// Icons
import { ContentCopyIcon, HelpOutlineIcon } from '@/icons'
import { ThemeOptions } from '@mui/material/styles';
import { colors } from '@/theme/schemes/BloomreachTheme';


export default function DocumentsCopyModule() {
                          ...
                          <StyledTableRow key={index} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                            <StyledTableCell>
                              {(() => {
                                switch (page.status) {
                                  case 'new':
                                    return <Typography variant='button' sx={{ color: colors.success.main }}>Added</Typography>
                                  case 'updated':
                                    return <Typography variant='button' sx={{ color: colors.success.main }}>Updated</Typography>
                                  case 'failed':
                                    return <Typography variant='button' sx={{ color: colors.error.main }}>Failed</Typography>
                                  default:
                                    return null
                                }
                              })()}
