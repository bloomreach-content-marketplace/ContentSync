...
// Constants
import { DEFAULT_CHANNEL_PROPERTY_VALUES } from '@/lib/constants'
...
export default function CreateChannelParameterModal({
  ...
  const handleSubmit = async (event) => {
    ...
    // Create new channel property
    await putChannelParameter(environment, xAuthToken, channelId, formData.name, formData)
      .then(() => handleShowSnackbar('success', 'Channel Property Created'))
  ...
  return (
    ...
    >
      ...
      >
        <DialogTitle>
          <Typography variant='h3' sx={{ fontWeight: 'bold' }}>Create Channel Property</Typography>
          <IconButton
            aria-label='close'
            onClick={handleClose}
            sx={{
