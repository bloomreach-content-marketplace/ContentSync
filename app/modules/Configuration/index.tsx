...
// Contexts
import { ConfigurationContext, ErrorContext } from '@/contexts'

// Icons
import { AddIcon, DifferenceIcon, LanguageIcon, SwapHorizIcon, Visibility, VisibilityOff } from '@/icons'
    ...
    <>
      ...
      { showCreateSourceProjectModal &&
        <CreateProjectModal
          ...
          setProjects={setSourceDeveloperProjects}
      ...
      { showCreateTargetProjectModal &&
        <CreateProjectModal
          ...
          setProjects={setTargetDeveloperProjects}
