...
import { StatusIndicator, TabPanel } from '@/components'
...
// Icons
import { DocumentIcon, LanguageIcon, ResourceBundleIcon, WebIcon } from '@/icons'
...
export const ProjectsDetailsModule = ({ instance, projectId }) => {
  ...
  const [projectData, setProjectData] = useState<DeveloperProjectProps | null>(null)
                ...
                <CardContent sx={{ fontWeight: 'bold' }}>
                  ...
                  <TabPanel value={value} index={1}>
                    { projectData?.items?.documents?.length
                      ...
                      : <Box sx={{px:1}}>
                          <Alert severity='warning'>No Documents in this Project.</Alert>
                        </Box>
                    }
                  </TabPanel>
                  ...
                  <TabPanel value={value} index={2}>
                    { projectData?.items?.pages?.length
                      ...
                      : <Box sx={{px:1}}>
                          <Alert severity='warning'>No Pages in this Project.</Alert>
                        </Box>
                    }
                  </TabPanel>
                  ...
                  <TabPanel value={value} index={3}>
                    { projectData?.items?.resourceBundles?.length
                      ...
                      : <Box sx={{px:1}}>
                          <Alert severity='warning'>No Resource Bundles in this Project.</Alert>
                        </Box>
                    }
                  </TabPanel>
